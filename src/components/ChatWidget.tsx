...
const ChatWidget = () => {
    ...
    const [messages, setMessages] = useState<Message[]>([
        { role: "assistant", content: "¡Hola! Bienvenido a GTP SaaS - Business Hub. Soy tu asistente de atención al cliente. ¿En qué puedo ayudarte hoy sobre nuestros servicios?" }
    ]);
